    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('name', '', ['class' => 'form-control', 'id' => 'txtDepartmentName']) !!}
                @error('name')
        ...
        <div class="col-sm-8">
            <div class="form-group">
                ...
                {!! Form::text('description', '', ['class' => 'form-control', 'id' => 'txtDepartmentDescrption']) !!}
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('block', $blocks, null, ['class' => 'form-control', 'id' => 'slctBlock']) !!}
            </div>
        </div>
